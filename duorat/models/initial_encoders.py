...
from duorat.preproc.offline import (
    ...
    BertDuoRATPreproc,
    SingletonGloVe, GRAPPADuoRATPreproc,
)
...
class BertEncoder(InitialEncoder):
    def __init__(
        ...
        assert isinstance(preproc, BertDuoRATPreproc) or isinstance(preproc, GRAPPADuoRATPreproc)
    ...
    def _forward_segment(
        ...
        #     print(input_a.max())
        #     print(input_a.shape)
        #     print(input_key_padding_mask)
        #     print(input_key_padding_mask.shape)
        #     print(device)
        #     input_key_padding_mask.to(device=device)
        #     # input()
        #     print(_input_attention_mask)
        #     print(_input_token_type_ids)
        #     print(_input_position_ids)
        #     input()
        #     raise e

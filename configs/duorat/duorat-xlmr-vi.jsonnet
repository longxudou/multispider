...
(import 'duorat-base.libsonnet')(output_from=true) {
    ...
    data: {
        train: (import '../data/train_vi.libsonnet')(prefix=PREFIX),
        val: (import '../data/val_vi.libsonnet')(prefix=PREFIX),
    },
    lr_scheduler: {
        "decay_steps": 98000,
        "end_lr": 0,
    ...
    model+: {
        ...
        preproc+: {
            save_path: 'dataset/pkl/vi',
            target_vocab_pkl_path: 'dataset/pkl/vi/target_vocab.pkl',
            name: 'GRAPPADuoRAT',
            add_cls_token: true,
            add_sep_token: false,
